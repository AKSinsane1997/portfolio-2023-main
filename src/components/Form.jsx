...
const Form = () => {
    ...
    const formSubmitHandler = (e) => {
        ...
        send(
            "service_g6ucuuz", // Service ID
            "template_55kojem", // Template ID
            userInput,
            "vbdUqT6CQlUrSjhXa" // Public Key - https://dashboard.emailjs.com/admin/account
        )
            .then((response) => {
    ...
    const formSuccess = () => {
        toast(
            `Thanks ${userInput.from_name} for submitting your Query, AKS will get back to you shortly.`
        );
